...
class GantiPassword extends CI_Controller{
    ...
    public function gantiPasswordAksi()
    {
        ...
        $this->form_validation->set_rules('passBaru', 'New Password', 'required|matches[ulangPass]');
        $this->form_validation->set_rules('ulangPass', 'Password Confirmation', 'required');
