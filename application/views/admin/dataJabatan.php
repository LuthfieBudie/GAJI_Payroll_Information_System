    ...
    <tr>
        ...
        <td>
            <center>
                ...
                <a onclick="return confirm('apakah anda ingin menghapus?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/dataJabatan/deleteData/'.$j->id_jabatan) ?>"><i class="fas fa-trash"></i></a>
            </center>
        </td>
</tr>
    <?php endforeach; ?>
