            ...
            <?php $no=1; foreach($pot_gaji as $p) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a onclick="return confirm('Apakah anda ingin menghapus?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/potonganGaji/deleteData/'.$p->id) ?>"><i class="fas fa-trash"></i></a>
                        </center>
                    </td>
                </tr>
                <?php endforeach; ?>
